...
ctx.strokeStyle = '#555';
ctx.lineWidth = 2;
const photoX = 60, photoY = 230, photoSize = 220;
...
ctx.fillStyle = '#ff6b35';
ctx.fillText('Expert Service', 340, 260);
...
services.forEach((service, i) => {
  ctx.fillText(service, 340, 300 + (i * 30));
});

// Contact
ctx.font = 'bold 16px Arial';
ctx.fillStyle = 'white';
ctx.fillText('📞 (973) 515-8818', 60, 520);

ctx.font = '16px Arial';
ctx.fillStyle = 'rgba(255,255,255,0.8)';
ctx.fillText('📍 Whippany, NJ | Mon-Sat: 8am-5:30pm', 60, 555);
